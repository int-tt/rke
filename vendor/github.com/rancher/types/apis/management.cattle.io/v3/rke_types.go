...
type AWSCloudProvider struct {
	// https://github.com/kubernetes/kubernetes/blob/master/pkg/cloudprovider/providers/aws/aws.go#L524-L568
	// TODO: Is there any use for this?  We can get it from the instance metadata service
	// Maybe if we're not running on AWS, e.g. bootstrap; for now it is not very useful
	Zone string `yaml:"zone" json:"zone,omitempty" ini:"zone,omitempty"`
	...
	VPC string `yaml:"vpc" json:"vpc,omitempty" ini:"vpc,omitempty"`
	// SubnetID enables using a specific subnet to use for ELB's
	SubnetID string `yaml:"subnet_id" json:"subnet_id,omitempty" ini:"subnet_id,omitempty"`
	// RouteTableID enables using a specific RouteTable
	RouteTableID string `yaml:"route_table_id" json:"route_table_id,omitempty" ini:"route_table_id,omitempty"`
	...
	DisableSecurityGroupIngress string `yaml:"disable_security_group_ingress" json:"disable_security_group_ingress,omitempty" ini:"disable_security_group_ingress,omitempty"`
	...
	ElbSecurityGroup string `yaml:"elb_security_group" json:"elb_security_group,omitempty" ini:"elb_security_group,omitempty"`
	...
	//issue body.
	DisableStrictZoneCheck bool `yaml:"disable_strict_zone_check" json:"disable_strict_zone_check,omitempty" ini:"disable_strict_zone_check,omitempty"`
}
